...
/**
 * 失败重试测试监听器：始终返回 FAIL，验证重试次数递减
 *
 * @Author xiaoqiang
 * @Version FailRetryListener.java, v 0.1 2025年06月23日 xiaoqiang
 */
@Component
@RetryOnClass(taskCode = "test-fail-retry")
public class FailRetryListener implements RetryLinstener<TestParam> {
