 ...
 * @Description: TODO
 */
public class SimpleRetryTaskCreator<T> implements RetryTaskCreator<T> {


    private RetryConfiguration retryConfiguration;
    public SimpleRetryTaskCreator(RetryConfiguration retryConfiguration) {
    ...
    public void createTask(RetryTaskBuilder<T> retryTaskBuilder) {
